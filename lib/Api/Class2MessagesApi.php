...
class Class2MessagesApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\ForwardMessageRequest $forward_message_request forward_message_request (required)
     *
     ...
     * Forwarding messages to a new or existing chat.
     *
     * @param  \OpenAPI\Client\Model\ForwardMessageRequest $forward_message_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     */
    public function forwardMessageRequest($forward_message_request)
    {
        ...
        if (isset($forward_message_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($forward_message_request));
            } else {
                $httpBody = $forward_message_request;
            }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMessagesRequest($last_message_number = null, $last = false, $chat_id = null, $limit = null, $min_time = null, $max_time = null)
    {
        ...
        if ($last_message_number !== null) {
            if('form' === 'form' && is_array($last_message_number)) {
                foreach($last_message_number as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['lastMessageNumber'] = $last_message_number;
            }
        }
        // query params
        if ($last !== null) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendContactRequest($send_contact_request)
    {
        ...
        if (isset($send_contact_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_contact_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendFileRequest($send_file_request)
    {
        ...
        if (isset($send_file_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_file_request));
            } else {
     ...
     *
     * @param  \OpenAPI\Client\Model\SendLinkRequest $send_link_request send_link_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SendMessageStatus
     ...
     * Send text with link and link's preview to a new or existing chat.
     *
     * @param  \OpenAPI\Client\Model\SendLinkRequest $send_link_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendLinkRequest($send_link_request)
    {
        ...
        if (isset($send_link_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_link_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendLocationRequest($send_location_request)
    {
        ...
        if (isset($send_location_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_location_request));
            } else {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendMessageRequest($send_message_request)
    {
        ...
        if (isset($send_message_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_message_request));
            } else {
     ...
     *
     * @param  \OpenAPI\Client\Model\SendPTTRequest $send_ptt_request send_ptt_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SendMessageStatus
     ...
     * Send a ptt-audio to a new or existing chat.
     *
     * @param  \OpenAPI\Client\Model\SendPTTRequest $send_ptt_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendPTTRequest($send_ptt_request)
    {
        ...
        if (isset($send_ptt_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_ptt_request));
            } else {
                $httpBody = $send_ptt_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     *
     * @param  \OpenAPI\Client\Model\SendVCardRequest $send_v_card_request send_v_card_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\SendMessageStatus
     ...
     * Sending a vcard to a new or existing chat.
     *
     * @param  \OpenAPI\Client\Model\SendVCardRequest $send_v_card_request (required)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\SendMessageStatus, HTTP status code, HTTP response headers (array of strings)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendVCardRequest($send_v_card_request)
    {
        ...
        if (isset($send_v_card_request)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($send_v_card_request));
            } else {
                $httpBody = $send_v_card_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
